...
TEST(ReadableOffStream, TestCreateDestroy) {
  ...
  block_cache_t* bc = block_cache_create((config_t){.lru_size = 10, .section_size = 128000, .cache_size = 10, .max_tuple_size = 30, .index_bucket_size = 10, .section_wait = 0, .section_max_wait = 0, .index_wait = 0, .index_max_wait = 0}, "/tmp/test_offs_stream_bc", standard, NULL);
