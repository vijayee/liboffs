...
static cbor_item_t* _recv_frame(int fd, stream_framer_t* framer, int timeout_ms = 3000) {
    uint8_t buf[65536];
...
protected:
    ...
    void SetUp() override {
        ...
        transport = tcp_transport_create(pool, bc, ofd_cache, tc, "127.0.0.1", port, NULL, NULL);
