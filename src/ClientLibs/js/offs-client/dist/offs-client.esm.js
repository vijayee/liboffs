...
var er = (t, e, r) => e in t ? Xt(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var B = (t, e, r) => er(t, typeof e != "symbol" ? e + "" : e, r);
class D {
  /**
   * @param {string} url
   * @param {string} [apiKey]
  ...
  async put(e, r) {
    ...
    const s = r && typeof r.getReader == "function", o = await fetch(this.url("/offsystem"), {
      method: "PUT",
      headers: n,
      body: r,
...
let x, le, c = 0;
const tr = 105, rr = 57342, nr = 57343, tt = 57337, rt = 6, de = {};
let ye = 11281e4, ie = 1681e4, T = {}, k, Ue, Pe = 0, Ee = 0, H, Z, F = [], Le = [], z, W, xe, nt = {
  useRecords: !1,
  mapsAsObjects: !0
}, ge = !1, pt = 2;
try {
...
class me {
  ...
  */
  ...
  decode(e, r) {
    if (x)
      return Et(() => (Ke(), this ? this.decode(e, r) : me.prototype.decode.call(nt, e, r)));
    le = r > -1 ? r : e.length, c = 0, Ee = 0, Ue = null, H = null, x = e;
    try {
  ...
  decodeMultiple(e, r) {
    ...
    try {
      let o = e.length;
      ge = !0;
      let l = this ? this.decode(e, o) : Qe.decode(e, o);
      if (r) {
        if (r(l) === !1)
          return;
        for (; c < o; )
  ...
  switch (e) {
    ...
    case 6:
      if (t >= tt) {
        let s = k[t & 8191];
        if (s)
          return s.read || (s.read = Me(s)), s.read();
        if (t < 65536) {
          if (t == nr) {
            let o = pe(), l = A(), p = A();
            je(l, p);
            ...
            return hr();
          if (T.getShared && (We(), s = k[t & 8191], s))
            return s.read || (s.read = Me(s)), s.read();
        }
      }
      let n = F[t];
...
function Me(t) {
  ...
  function e() {
    ...
    if (r = r & 31, r > 23)
      switch (r) {
        ...
        case 26:
          ...
          break;
        default:
          throw new Error("Expected array header, but got " + x[c - 1]);
      }
    ...
    if (this.slowReads++ >= pt) {
      let o = this.length == r ? this : this.slice(0, r);
      return n = T.keyMap ? new Function("r", "return {" + o.map((l) => T.decodeKey(l)).map((l) => st.test(l) ? Y(l) + ":r()" : "[" + JSON.stringify(l) + "]:r()").join(",") + "}") : new Function("r", "return {" + o.map((l) => st.test(l) ? Y(l) + ":r()" : "[" + JSON.stringify(l) + "]:r()").join(",") + "}"), this.compiledReader && (n.next = this.compiledReader), n.propertyCount = r, this.compiledReader = n, n(A);
    }
    let s = {};
...
function He(t) {
  ...
  if (t < 16 && (e = yt(t)))
    return e;
  if (t > 64 && Fe)
    return Fe.decode(x.subarray(c, c += t));
  const r = c + t, n = [];
  for (e = ""; c < r; ) {
    const s = x[c++];
    if (!(s & 128))
...
function or(t) {
  return T.copyBuffers ? (
    ...
    Uint8Array.prototype.slice.call(x, c, c += t)
  ) : x.subarray(c, c += t);
}
let xt = new Float32Array(1), Oe = new Uint8Array(xt.buffer, 0, 4);
function ar() {
  let t = x[c++], e = x[c++], r = (t & 127) >> 2;
  if (r === 31)
...
const je = (t, e) => {
  t = t - 57344;
  let r = k[t];
  r && r.isShared && ((k.restoreStructures || (k.restoreStructures = []))[t] = r), k[t] = e, e.read = Me(e);
};
F[tr] = (t) => {
...
F[258] = (t) => new Set(t);
(F[259] = (t) => (T.mapsAsObjects && (T.mapsAsObjects = !1, xe = !0), t())).handlesRead = !0;
function he(t, e) {
...
const cr = new Uint8Array(new Uint16Array([1]).buffer)[0] == 1, it = [
  Uint8Array,
  Uint8ClampedArray,
  Uint16Array,
  Uint32Array,
  ...
  Float32Array,
  Float64Array
], ur = [64, 68, 69, 70, 71, 72, 77, 78, 79, 85, 86];
...
function hr() {
  ...
  let r = c;
  return c = e, H = [He(pe()), He(pe())], H.position0 = 0, H.position1 = 0, H.postBundlePosition = c, c = r, A();
}
function pe() {
  let t = x[c++] & 31;
  if (t > 23)
...
function We() {
  if (T.getShared) {
    let t = Et(() => (x = null, T.getShared())) || {}, e = t.structures || [];
    T.sharedVersion = t.version, z = T.sharedValues = t.packedValues, k === !0 ? T.structures = k = e : k.splice.apply(k, [0, e.length].concat(e));
  }
}
function Et(t) {
  let e = le, r = c, n = Pe, s = Ee, o = Ue, l = Z, p = H, y = new Uint8Array(x.slice(0, le)), _ = k, g = T, P = ge, L = t();
  return le = e, c = r, Pe = n, Ee = s, Ue = o, Z = l, H = p, x = y, ge = P, k = _, T = g, W = new DataView(x.buffer, x.byteOffset, x.byteLength), L;
}
function Ke() {
  x = null, Z = null, k = null;
}
const ze = new Array(147);
for (let t = 0; t < 256; t++)
  ze[t] = +("1e" + Math.floor(45.15 - t * 0.30103));
let Qe = new me({ useRecords: !1 });
const $ = Qe.decode;
Qe.decodeMultiple;
let Te;
try {
...
let Ge, gt;
const Ne = typeof globalThis == "object" && globalThis.Buffer, Se = typeof Ne < "u", Be = Se ? Ne.allocUnsafeSlow : Uint8Array, ot = Se ? Ne : Uint8Array, at = 256, ft = Se ? 4294967296 : 2144337920;
let Ie, f, N, i = 0, oe, M = null;
const pr = 61440, yr = /[\u0080-\uFFFF]/, Q = Symbol("record-id");
class mt extends me {
  constructor(e) {
    super(e), this.offset = 0;
    let r, n, s, o, l;
    e = e || {};
    let p = ot.prototype.utf8Write ? function(a, w) {
      return f.utf8Write(a, w, f.byteLength - w);
    } : Te && Te.encodeInto ? function(a, w) {
      return Te.encodeInto(a, f.subarray(w)).written;
    ...
    this.mapEncode = function(a, w) {
      ...
      if (f || (f = new Be(8192), N = new DataView(f.buffer, 0, 8192), i = 0), oe = f.length - 10, oe - i < 2048 ? (f = new Be(f.length), N = new DataView(f.buffer, 0, f.length), oe = f.length - 10, i = 0) : w === ut && (i = i + 7 & 2147483640), r = i, y.useSelfDescribedHeader && (N.setUint32(i, 3654940416), i += 3), l = y.structuredClone ? /* @__PURE__ */ new Map() : null, y.bundleStrings && typeof a != "string" ? (M = [], M.size = 1 / 0) : M = null, n = y.structures, n) {
        if (n.uninitialized) {
          let h = y.getShared() || {};
      ...
      if (s && (s = !1), o = n || [], G = C, e.pack) {
        ...
        if (d.values = [], d.encoder = y, d.maxValues = e.maxPrivatePackedValues || (C ? 16 : 1 / 0), d.objectMap = C || !1, d.samplingPackedValues = L, Ae(a, d), d.values.length > 0) {
          f[i++] = 216, f[i++] = 51, te(4);
          let h = d.values;
      ...
      try {
        if (Ie)
          return;
        if (S(a), M && ct(r, S), y.offset = i, l && l.idsToInsert) {
          i += l.idsToInsert.length * 2, i > oe && J(i), y.offset = i;
          let d = Er(f.subarray(r, i), l.idsToInsert);
          return l = null, d;
        }
        return w & ut ? (f.start = r, f.end = i, f) : f.subarray(r, i);
      } finally {
        if (n) {
    ...
    const S = (a) => {
      ...
      if (w === "string") {
        ...
        if (M && h >= 4 && h < 1024) {
          if ((M.size += h) > pr) {
            ...
            i + O > oe && (f = J(i + O)), f[i++] = 217, f[i++] = 223, f[i++] = 249, f[i++] = M.position ? 132 : 130, f[i++] = 26, R = i - r, i += 4, M.position && ct(r, S), M = ["", ""], M.size = 0, M.position = R;
          }
          let b = yr.test(a);
        ...
        if (!a)
          ...
          if (h === Object)
            ...
            if (a[Symbol.asyncIterator] || Ce(a)) {
      ...
      if (this.keyMap) {
        ...
        for (let U = 0; U < m; U++) {
          let et = R[U];
          d = h[et], d || (d = h[et] = /* @__PURE__ */ Object.create(null), u++), h = d;
        }
      } else
      ...
      else if (R || (R = h.__keys__ || (h.__keys__ = Object.keys(a))), b === void 0 ? (O = o.nextId++, O || (O = 0, o.nextId = 1), O >= at && (o.nextId = (O = g) + 1)) : O = b, o[O] = R, O < g) {
        f[i++] = 217, f[i++] = O >> 8 | 224, f[i++] = O & 255, h = o.transitions;
        for (let U = 0; U < m; U++)
          (h[Q] === void 0 || h[Q] & 1048576) && (h[Q] = O), h = h[R[U]];
        h[Q] = O | 1048576, s = !0;
      } else {
        if (h[Q] = O, N.setUint32(i, 3655335680), i += 3, u && (re += I * u), q.length >= at - g && (q.shift()[Q] = void 0), q.push(h), te(m + 2), S(57344 + O), S(R), w) return;
        for (let U in a)
    ...
    function* ne(a, w, d) {
      ...
      if (h === Object) {
        ...
        u ? X(a, !0) : lt(Object.keys(a).length, 160);
        for (let m in a) {
          let b = a[m];
        ...
        f[i++] = 255;
      } else Ce(a) ? (lt(a.size, 64), yield f.subarray(r, i), yield a, se()) : a[Symbol.asyncIterator] ? (f[i++] = 159, yield f.subarray(r, i), yield a, se(), f[i++] = 255) : S(a);
    ...
    function be(a, w, d) {
      return w && w.chunkThreshold ? v = ae = w.chunkThreshold : v = 100, a && typeof a == "object" ? (y.encode(null, ke), d(a, y.iterateProperties || (y.iterateProperties = {}), !0)) : [y.encode(a)];
    }
    async function* _e(a, w) {
      for (let d of ne(a, w, !0)) {
        let h = d.constructor;
        if (h === ot || h === Uint8Array)
          yield d;
        else if (Ce(d)) {
  ...
  updateSharedData() {
    ...
    let r = this.structures.slice(0), n = new St(r, this.sharedValues, this.sharedVersion), s = this.saveShared(
      n,
      (o) => (o && o.version || 0) == e
    );
...
const wr = new Uint8Array(new Uint16Array([1]).buffer)[0] == 1;
gt = [
  Date,
  Set,
  Error,
...
let Je = new mt({ useRecords: !1 });
const gr = Je.encode;
Je.encodeAsIterable;
Je.encodeAsAsyncIterable;
const ut = 512, mr = 1024, ke = 2048, K = new mt({ tagUint8Array: !1 }), E = {
  PUT_REQUEST: 1,
  PUT_DATA: 2,
  PUT_END: 3,
  PUT_RESPONSE: 4,
...
const jr = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  MSG: E,
  STATUS: Sr,
  decodeBlockDeleteResponse: kt,
  decodeBlockGetResponse: It,
  decodeBlockPutResponse: Nt,
  decodeConfigReloadResponse: Yt,
  decodeConfigSetResponse: Jt,
  decodeConfigShowResponse: zt,
  decodeError: Ut,
  decodeFriendListResponse: Vt,
  decodeGetData: Tt,
  decodeGetResponseStart: Ot,
  decodeHealthResponse: Ft,
  decodePeerConnectResult: jt,
  decodePeerInfoResponse: Mt,
  decodePeerListResponse: Gt,
  decodePutResponse: ve,
  encodeAuthRequest: Ye,
  encodeBlockDeleteRequest: Ct,
  encodeBlockGetRequest: Bt,
  encodeBlockPutRequest: Pt,
  encodeConfigReloadRequest: Zt,
  encodeConfigSetRequest: Qt,
  encodeConfigShowRequest: Wt,
  encodeFriendAdd: qt,
  encodeFriendListRequest: vt,
  encodeFriendRemove: $t,
  encodeGetRequest: Rt,
  encodeHealthRequest: Dt,
  encodePeerConnect: Ht,
  encodePeerInfoRequest: Lt,
  encodePeerListRequest: Kt,
  encodePutData: bt,
  encodePutEnd: _t,
  encodePutRequest: $e,
  getMessageType: Ze,
...
class br {
  ...
  connect() {
    return this.socket ? this.openPromise || Promise.resolve() : (this.socket = new WebSocket(this.url), this.socket.binaryType = "arraybuffer", this.openPromise = new Promise((e, r) => {
      ...
      n.onopen = () => {
        this.apiKey && this.send(Ye(this.apiKey)), e();
      }, n.onerror = (s) => {
        var l;
        ...
        var p;
        const o = new Uint8Array(s.data), l = Ze(o);
...
class _r {
  ...
  async connect() {
    return this.transport ? this.openPromise || Promise.resolve() : (this.transport = new WebTransport(this.url), this.openPromise = this.transport.ready.then(async () => {
      ...
      this.writer = e.writable.getWriter(), this.reader = e.readable.getReader(), this.running = !0, this._readLoop(), this.apiKey && await this.send(Ye(this.apiKey));
    }), this.openPromise);
  }
  disconnect() {
    var e, r, n;
...
const Ve = "123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz", Xe = new Int8Array(128);
Xe.fill(-1);
for (let t = 0; t < Ve.length; t++)
  Xe[Ve.charCodeAt(t)] = t;
function we(t) {
...
function De(t) {
  ...
  return "1".repeat(r) + n.reverse().map((o) => Ve[o]).join("");
}
function dt(t) {
...
function Ur(t, e = "http://localhost:23402") {
...
function Dr(t, e, r) {
  return t.startsWith("ws://") || t.startsWith("wss://") ? new br(t, e, r) : t.startsWith("wt://") || t.startsWith("wts://") ? new _r(t, e, r) : new D(t, e, r);
}
class Kr {
  /**
   * @param {string} url
  ...
  constructor(e, r, n) {
    ...
    /** @type {boolean} */
    B(this, "connected", !1);
    this.url = e, this.apiKey = r, this.config = { ...kr(), ...n }, this.transport = (n == null ? void 0 : n.transport) || Dr(e, r, n), this.transport.setMessageHandler(this._onMessage.bind(this));
  }
  /**
   * @returns {Promise<void>}
   */
  ...
  async put(e, r) {
    ...
    const n = $e(e, r), s = await this._sendAndWait(n, E.PUT_RESPONSE);
    return ve(s);
  }
  /**
  ...
  async putStreamData(e) {
    ...
    await this.transport.send(bt(e));
  }
  /**
   * @returns {Promise<{oriString: string}>}
   */
  ...
  async get(e, r, n) {
    ...
    const s = Rt(e, n), o = await this._sendAndWait(s, E.GET_RESPONSE_START), l = Ot(o);
  ...
  async blockPut(e, r = 0) {
    ...
    const n = Pt(e, r), s = await this._sendAndWait(n, E.BLOCK_PUT_RESPONSE);
    return Nt(s);
  }
  /**
  ...
  async blockGet(e) {
    ...
    const r = Bt(e), n = await this._sendAndWait(r, E.BLOCK_GET_RESPONSE);
    return It(n);
  }
  /**
   * @param {string|Uint8Array} hash
  ...
  async blockDelete(e) {
    ...
    const r = Ct(e), n = await this._sendAndWait(r, E.BLOCK_DELETE_RESPONSE);
    return kt(n);
  }
  /**
   * @returns {Promise<any>}
  ...
  async health() {
    ...
    const e = Dt(), r = await this._sendAndWait(e, E.HEALTH_RESPONSE), { json: n } = Ft(r);
    return JSON.parse(n);
  }
  /**
   * @param {string} [format='cbor']
  ...
  async peerInfo(e = "cbor") {
    ...
    const r = Lt(), n = await this._sendAndWait(r, E.PEER_INFO_RESPONSE);
    return Mt(n);
  }
  /**
   * @param {Uint8Array} peerInfo
  ...
  async peerConnect(e, r = 0) {
    ...
    const n = Ht(r, e), s = await this._sendAndWait(n, E.PEER_CONNECT_RESULT);
    return jt(s);
  }
  /**
  ...
  async peerList() {
    ...
    const e = Kt(), r = await this._sendAndWait(e, E.PEER_LIST_RESPONSE);
    return Gt(r);
  }
  /**
   * @param {Uint8Array} peerInfo
  ...
  async friendRemove(e) {
    ...
    const r = typeof e == "string" ? new TextEncoder().encode(e) : e, n = $t(r);
    await this.transport.send(n);
  }
  /**
   * @returns {Promise<any[]>}
  ...
  async configShow() {
    ...
    const e = Wt(), r = await this._sendAndWait(e, E.CONFIG_SHOW_RESPONSE), { json: n } = zt(r);
    return JSON.parse(n);
  }
  /**
   * @param {string} field
  ...
  async configSet(e, r) {
    ...
    const n = Qt(e, r), s = await this._sendAndWait(n, E.CONFIG_SET_RESPONSE);
    return Jt(s);
  }
  /**
  ...
  async configReload() {
    ...
    const e = Zt(), r = await this._sendAndWait(e, E.CONFIG_RELOAD_RESPONSE);
    return Yt(r);
  }
  /**
  ...
  async putFolder(e, r = {}) {
    ...
    const p = (g) => {
    ...
    }, y = Fr(n.map((g) => g.path)), _ = async (g) => {
      const P = g ? g.split("/").pop() : y.split("/").pop() || "root", G = Lr(n, g), V = Mr(n, g), C = [];
      for (const I of V) {
        const X = (await _(I)).oriString, J = dt(X);
        if (!J)
      ...
      for (const I of G) {
        const S = I.path.split("/").pop() || I.path, X = Or(S), J = I.file.size;
        let v;
        if (this.transport instanceof D) {
          const se = ht(I.file);
          v = (await this.put({
...
export {
  ...
  we as base58Decode,
  De as base58Encode,
  Or as mimeFromExtension,
  Ur as offUrlToHttpUrl,
  dt as parseOffUrl,
  jr as wire
};
